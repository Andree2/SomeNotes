﻿function Person()
{
    ...
    function BuildEditTable(displayName, firstName, middleName, lastName, birthdayDay, birthdayMonth, birthdayYear, text, importance, category)
    {
        var output = ""
            ...
            +"  </tr>"
            +"  <tr>"
            +"    <td class='noWrap'>Name (first-middle-last)</td>"
            +"    <td colspan='3'>"
            ...
            +"    <td>Text</td>"
            +"    <td colspan='3' class='fillTable'>"
            +"      <textarea id='input_person_text' name='input_person_text' type='text' rows='20' class='fillCell'>"+ My.HtmlSpecialChars(text) +"</textarea>"
            +"    </td>"
            +"  </tr>"
            +"  <tr>"
            +"    <td>Importance</td>"
