function Place()
{
    ...
    function BuildEditTable(title, address, latitude, longitude, importance, category)
    {
        ...
        var output = ""
            ...
            +"  <tr>"
            +"    <td>Address</td>"
            +"    <td colspan='5' class='fillTable'><textarea id='input_place_address' name='input_place_address' type='text' class='fillCell' rows='20'>"+ My.HtmlSpecialChars(address) +"</textarea></td>"
            +"  </tr>"
            +"  <tr>"
            +"    <td>Lat/Long</td>"
